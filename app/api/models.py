...
# ===================================
# Model Cache & Promotion response models (defined before routes that use them)
# ===================================
...
# ===================================
# GET /models/cache  (must be before /{model_id})
# ===================================
...
# ===================================
# GET /models/promoted  (must be before /{model_id})
# ===================================
