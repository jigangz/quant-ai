    ...
    train.mutate(
      {
        ...
        // /api/meta-label/train schema accepts: xgboost | lightgbm | ensemble.
        // xgboost is the default per spec — works on Render after the
        // libgomp1 install (Dockerfile c305be0).
        model: { type: "xgboost" },
